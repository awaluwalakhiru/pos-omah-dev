...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //permission items
        Permission::create(['name' => 'items.index', 'guard_name' => 'web']);
        Permission::create(['name' => 'items.create', 'guard_name' => 'web']);
        Permission::create(['name' => 'items.edit', 'guard_name' => 'web']);
        Permission::create(['name' => 'items.delete', 'guard_name' => 'web']);
        ...
        //permission sale details
        Permission::create(['name' => 'saleDetails.index', 'guard_name' => 'web']);
