    ...
    <div class="container-fluid iq-container">
      <div class="row">
        <div class="col-md-12">
          ...
          >
            <div>
              <h1>POS (Point of Sales) OmahDev</h1>
              <p>
                We are a modern Point of Sale website create with passion to serve our customers.
              </p>
            </div>
            <div hidden>
              <a href="" class="btn btn-link btn-soft-light disabled">
                <svg
                  class="icon-20"
                  width="20"
                  viewBox="0 0 24 24"
