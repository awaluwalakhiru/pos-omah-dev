<template>
  ...
  <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
      <Link href="/apps/dashboard" class="navbar-brand navbar-link">
        <!--Logo start-->
        <!--logo End-->
        ...
        <h5 class="logo-title">POS OmahDev</h5>
      </Link>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        >
          ...
          <li class="nav-item dropdown d-none">
            ...
            >
              <div class="m-0 border-0 shadow-none card d-none">
                <div class="p-0">
          ...
          <li class="nav-item dropdown d-none">
            ...
            >
              <div class="m-0 shadow-none card d-none">
                <div
          ...
          <li class="nav-item dropdown">
            ...
            >
              ...
              <li>
                <Link href="/logout" method="post" class="dropdown-item"
                  >Logout</Link
                >
              </li>
            </ul>
...
<script>
import { toolbarToggle } from "@/Composables/globalComposable.js";
