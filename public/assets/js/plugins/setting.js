...
(function () {
    ...
    // custom refactored swap class in native mode javascript
    function swapClasses(selector, addClasses, removeClass) {
    ...
    const rtlModeDefault = (check) => {
        if (check) {
            swapClasses('.offcanvas-start', ['on-rtl', 'start'], 'offcanvas-start');
            swapClasses('.offcanvas-end', ['on-rtl', 'end'], 'offcanvas-end');
            swapClasses('.on-rtl.start', ['offcanvas-end'], 'start');
            swapClasses('.on-rtl.end', ['offcanvas-start'], 'end');
        } else {
            swapClasses('.offcanvas-start', ['on-rtl', 'start'], 'offcanvas-start');
            swapClasses('.offcanvas-end', ['on-rtl', 'end'], 'offcanvas-end');
            swapClasses('.on-rtl.start', ['offcanvas-end'], 'start');
